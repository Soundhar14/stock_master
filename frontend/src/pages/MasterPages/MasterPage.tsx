  ...
  const configCards: ConfigCardtype[] = [
    {
      ...
      title: 'Warehouse',
      desc: 'Manage office branches to streamline your organizational structure.',
      label: 'Organisation',
    ...
    //   title: 'Department',
    //   desc: 'Define departments to organize teams and responsibilities effectively.',
    //   label: 'Organisation',
    //   labelColor: 'bg-red-100 text-red-800',
    //   btnText: 'Configure',
    //   navigateUrl: appRoutes.masterRoutes.children.departments,
    // },
    // {
